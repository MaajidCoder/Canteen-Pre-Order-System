  ...
  return (
    <div className="container py-20 reveal flex justify-center items-center" style={{ minHeight: '80vh' }}>
      <div className="card auth-card shadow-2xl overflow-hidden">
        {/* Top Accent Bar */}
        <div className="accent-bar bg-secondary"></div>

        <div className="text-center mb-10 pt-4">
          <div className="auth-icon-wrapper bg-amber-50 text-secondary">
            <UserPlus size={36} />
          </div>
          <h1 className="text-4xl font-black mb-2">Join CanteenHub</h1>
          <p className="text-gray font-bold">The smartest way to eat on campus</p>
        </div>
        ...
        <div className="footer-link-box">
            <p className="text-gray font-bold text-center">
                Already part of the hub? <Link to="/login" className="text-secondary font-black ml-1" style={{ textDecoration: 'none' }}>Login Here</Link>
            </p>
        </div>
      </div>
